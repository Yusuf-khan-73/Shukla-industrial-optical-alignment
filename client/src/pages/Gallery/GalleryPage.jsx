...
const GalleryPage = () => (
  <>
    <PageHero
      title="Gallery"
      subtitle="Industrial optical alignment, machinery installation, and paper mill project photography."
    ...
    <section className="page-content section-padding-sm bg-light">
      <div className="container-custom text-center" data-aos="fade-up">
        ...
        <p className="section-subtitle mx-auto mb-4">
          Partner with Shukla Industrial for precision alignment and installation services across India.
        </p>
